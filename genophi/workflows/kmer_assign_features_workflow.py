...
def run_kmer_assign_features_workflow(input_dir, mmseqs_db, tmp_dir, output_dir, feature_map, filtered_kmers, aa_sequence_file, clusters_tsv, genome_type, genome_list=None, sensitivity=7.5, coverage=0.8, min_seq_id=0.4, threads=4, suffix='faa', threshold=0.5, reuse_existing=True):
    """
