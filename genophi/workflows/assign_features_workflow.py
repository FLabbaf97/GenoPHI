...
from genophi.mmseqs2_clustering import create_mmseqs_database, load_strains, create_contig_to_genome_dict, select_best_hits_streaming, _read_table, _write_table, _resolve_table_path
...
def main():
    ...
    parser.add_argument('--feature_map', type=str, required=True, help="Path to the feature map (selected_features.csv or selected_features.pq).")
