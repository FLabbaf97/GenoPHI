...
def run_protein_family_workflow(
    ...
    try:
        ...
        elif os.path.exists(_resolve_table_path(os.path.join(output_dir, "strain", "features", "feature_table.csv"))):
        ...
        if not os.path.exists(_resolve_table_path(strain_features_path)):
        ...
        if input_path_phage:
            ...
            elif os.path.exists(_resolve_table_path(os.path.join(output_dir, "phage", "features", "feature_table.csv"))):
                logging.info("Using existing phage clustering results...")
        ...
        feature_file_path = _resolve_table_path(os.path.join(output_dir, 'feature_selection', 'filtered_feature_tables', f'select_feature_table_cutoff_{top_cutoff}.csv'))
